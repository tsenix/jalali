(() => {
    ...
    function initSliders() {
        if (document.querySelector(".teachers__body")) new Swiper(".teachers__body", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            autoHeight: true,
            speed: 800,
            navigation: {
                prevEl: ".teachers__button-left",
                nextEl: ".teachers__button-right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 2,
        ...
        if (document.querySelector(".feedbacks__body")) new Swiper(".feedbacks__body", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".feedbacks__button-left",
                nextEl: ".feedbacks__button-right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".partners__body")) new Swiper(".partners__body", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".partners__button-left",
                nextEl: ".partners__button-right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 2,
    ...
    const openSearch = document.querySelector(".header__search-mobile-open");
    const headerLogo = document.querySelector(".header__logo");
    const searchBody = document.querySelector(".header__search-mobile");
    const closeSearch = document.querySelector(".header__search-mobile-close");
